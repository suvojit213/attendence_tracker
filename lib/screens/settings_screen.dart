...
class AboutContentScreen extends StatefulWidget {
  AboutContentScreen({super.key});

  @override
  State<AboutContentScreen> createState() => _AboutContentScreenState();
}

class _AboutContentScreenState extends State<AboutContentScreen> {
